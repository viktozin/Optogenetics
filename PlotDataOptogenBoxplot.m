function PlotDataOptogenBoxplot(root, resdir, NoDupesSafeData, NoDupesScaryData, mins, TypeOfTest, ScaryZoneSubstring, SafeZoneSubstring, Table)
...
for i = 10:length(NoDupesScaryData.Properties.VariableNames)
    ...
    F = figure();
    boxplot(allData, group, 'Labels', {'ScaryGFP', 'SafeGFP', 'ScaryChR2', 'SafeChR2'});
    hold on
...
title([VarStr, ', ', VarStrUnit], 'FontSize', 22, 'Units', 'normalized', 'Position', [0.5, 1.02, 0]);
