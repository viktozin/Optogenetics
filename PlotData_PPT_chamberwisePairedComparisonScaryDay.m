function PlotData_PPT_chamberwisePairedComparisonScaryDay(root, resdir, NoDupesSafeData,NoDupesScaryData, mins, TypeOfTest, ScaryZoneSubstring, SafeZoneSubstring)
...
setmyplot_balazs
    ...
    fnm = fullfile(resdir,'Average plots',strcat(Srepl,'_Paired_Stim_duration',num2str(mins),'Mins.png'));%fullfile(StatisticPlots, strcat(TypeOfTest,'_',ExperimentFolders{i},'_ZoneTransition_', nameFolds{h}, '.png'));
    fnm1 = fullfile(resdir,'Average plots',strcat(Srepl,'_Paired_Stim_duration',num2str(mins),'Mins.fig'));%fullfile(StatisticPlots, strcat(TypeOfTest,'_',ExperimentFolders{i},'_ZoneTransition_', nameFolds{h}, '.png'));
    fnm2 = fullfile(resdir,'Average plots',strcat(Srepl,'_Paired_Stim_duration',num2str(mins),'Mins.svg'));%fullfile(StatisticPlots, strcat(TypeOfTest,'_',ExperimentFolders{i},'_ZoneTransition_', nameFolds{h}, '.png'));
